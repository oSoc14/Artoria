...
/**
 * This is the plugin loading activity for be.artoria.belfortapp.mixare. This activity will load a splashscreen and then initializes the PluginLoader
 * It will then launch the visible bootstrap plugins and waits for their results. After all bootstrap plugins are loaded
 * then be.artoria.belfortapp.mixare will be launched.
 * @author A.Egal
 */
