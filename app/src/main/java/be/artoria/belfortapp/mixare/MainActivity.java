...
import be.artoria.belfortapp.mixare.plugin.PluginType;
...
/**
 * This is the main activity of be.artoria.belfortapp.mixare, that will be opened if be.artoria.belfortapp.mixare is
...
public class MainActivity extends Activity {
	...
	public void showDialog() {
		...
		dialog.setMessage(be.artoria.belfortapp.R.string.plugin_message);

		final CheckBox checkBox = new CheckBox(ctx);
		checkBox.setText(be.artoria.belfortapp.R.string.remember_this_decision);
		dialog.setView(checkBox);		
		
		dialog.setPositiveButton(be.artoria.belfortapp.R.string.yes, new DialogInterface.OnClickListener() {
		...
		dialog.setNegativeButton(be.artoria.belfortapp.R.string.no,new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface d, int whichButton) {
				processCheckbox(true, checkBox);
				startActivity(new Intent(ctx, MixView.class));
				finish();
