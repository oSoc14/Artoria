...
import be.artoria.belfortapp.mixare.lib.service.IMarkerService;
import be.artoria.belfortapp.mixare.plugin.connection.ActivityConnection;
import be.artoria.belfortapp.mixare.plugin.connection.MarkerServiceConnection;
import be.artoria.belfortapp.mixare.plugin.remoteobjects.RemoteMarker;
