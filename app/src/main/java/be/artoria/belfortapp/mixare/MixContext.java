...
import be.artoria.belfortapp.mixare.mgr.datasource.DataSourceManager;
import be.artoria.belfortapp.mixare.mgr.datasource.DataSourceManagerFactory;
import be.artoria.belfortapp.mixare.mgr.downloader.DownloadManager;
import be.artoria.belfortapp.mixare.mgr.downloader.DownloadManagerFactory;
import be.artoria.belfortapp.mixare.mgr.location.LocationFinder;
import be.artoria.belfortapp.mixare.mgr.location.LocationFinderFactory;
import be.artoria.belfortapp.mixare.mgr.webcontent.WebContentManager;
import be.artoria.belfortapp.mixare.mgr.webcontent.WebContentManagerFactory;
