 ...
 */
package be.artoria.belfortapp.mixare.plugin;

import be.artoria.belfortapp.mixare.plugin.connection.BootStrapActivityConnection;
import be.artoria.belfortapp.mixare.plugin.connection.DataHandlerServiceConnection;
import be.artoria.belfortapp.mixare.plugin.connection.MarkerServiceConnection;
...
public enum PluginType{
	...
	BOOTSTRAP_PHASE_1(){
		...
		public String getActionName() {
			return "org.be.artoria.belfortapp.mixare.plugin.bootstrap1";
		}
	...
	BOOTSTRAP_PHASE_2(){
		...
		public String getActionName() {
			return "org.be.artoria.belfortapp.mixare.plugin.bootstrap2";
		}
	...
	DATASELECTOR(){
		...
		public String getActionName() {
			return "org.be.artoria.belfortapp.mixare.plugin.dataselector";
		}
	...
	MARKER(){
		...
		public String getActionName() {
			return "org.be.artoria.belfortapp.mixare.plugin.marker";
		}
	...
	DATAHANDLER(){
		...
		public String getActionName() {
			return "org.be.artoria.belfortapp.mixare.plugin.datahandler";
		}
