 ...
 */
package be.artoria.belfortapp.mixare.lib.marker.draw;
...
public class DrawTextBox extends DrawCommand {
	...
	public DrawTextBox(Boolean visible, Double distance, String title, Boolean underline, TextObj textblock, Label textlab, MixVector signMarker){
		...
		setProperty(PROPERTY_NAME_TEXTBLOCK, new ParcelableProperty("TextObj", textblock));
		setProperty(PROPERTY_NAME_TEXTLAB, new ParcelableProperty("Label", textlab ));
		setProperty(PROPERTY_NAME_SIGNMARKER, new ParcelableProperty("MixVector", signMarker));
	}
